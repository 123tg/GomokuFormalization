...
NOTES = [
    ...
    '第二，空棋盘和棋其实只差一环：黑防白已经用策略偷取证明了，还缺白防黑，'
    '补上就能组合出空棋盘 StandardDraw；第三，缓存已经定义好，但还没接入默认搜索流程；'
    '第四，目前只在一步胜、双应手和中盘和棋这些局面上验证过，规模没有跑起来。',
    # 27 不足②
    ...
    '以及 9 个中盘和棋局面；没有做的是空棋盘开局求解、空棋盘“白防黑”（只差这一环）'
    '和大规模验证。谢谢大家，欢迎提问。',
]
